...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::view_indexed_message_channels,
            commands::view_asset_messages_paged,
            commands::view_channel_messages_paged,
            commands::rescan_messages,
            commands::merge_asset_messages,
            ...
            files::parse_current_config,
            files::preview_config_changes,
            files::apply_guided_config,
            files::get_config_help_reference,
            files::get_addnode_hosts,
